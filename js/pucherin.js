...
function inicio() {
    ...
    let divDados1 = document.getElementById("divDados1"); // Con el primer div de los dados cogemos el id
    let divDados2 = document.getElementById("divDados2"); // Cogemos el id del segundo div de los dados
    let music = document.getElementById("music");
    let dadin1 = document.getElementById("dado1"); // Cogemos todas las imágenes de los dados de los dos divs
    ...
    dadin1.style.display = "none"; // Deshabilitamos que se vean las imágenes de los dados al cargar la página
...
function dados() {
    ...
    switch(dado.dado1) // Para el primer dado
    {
        case 1: // Para el caso de que salga un 1
            dadin1.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadin2.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadin3.style.display = "none";
            dadin4.style.display = "none";
            dadin5.style.display = "none";
            dadin6.style.display = "none";
        break;
        case 2: // Para el caso de que salga un 2
            dadin1.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadin2.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadin3.style.display = "none";
            dadin4.style.display = "none";
            dadin5.style.display = "none";
            dadin6.style.display = "none";
        break;
        case 3: // Para el caso de que salga un 3
            dadin1.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadin2.style.display = "none";
            dadin3.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadin4.style.display = "none";
            dadin5.style.display = "none";
            dadin6.style.display = "none";
        break;
        case 4: // Para el caso de que salga un 4
            dadin1.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadin2.style.display = "none";
            dadin3.style.display = "none";
            dadin4.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadin5.style.display = "none";
            dadin6.style.display = "none";
        break;
        case 5: // Para el caso de que salga un 5
            dadin1.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadin2.style.display = "none";
            dadin3.style.display = "none";
            dadin4.style.display = "none";
            dadin5.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadin6.style.display = "none";
        break;
        case 6: // Para el caso de que salga un 6
            dadin1.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadin2.style.display = "none";
            dadin3.style.display = "none";
            dadin4.style.display = "none";
            dadin5.style.display = "none";
            dadin6.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
        break;
    }
    switch(dado.dado2) // Para el segundo dado
    {
        case 1: // Para el caso de que salga un 1
            dadito1.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadito2.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadito3.style.display = "none";
            dadito4.style.display = "none";
            dadito5.style.display = "none";
            dadito6.style.display = "none";
        break;
        case 2: // Para el caso de que salga un 2
            dadito1.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadito2.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadito3.style.display = "none";
            dadito4.style.display = "none";
            dadito5.style.display = "none";
            dadito6.style.display = "none";
        ...
        case 3: // Para el caso de que salga un 3
            dadito1.style.display = "none"; // Se deshabilitan el resto de imágenes
            dadito2.style.display = "none";
            dadito3.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadito4.style.display = "none";
            dadito5.style.display = "none";
            dadito6.style.display = "none";
        break;
        case 4: // Para el caso de que salga un 4
            ...
            dadito2.style.display = "none";
            dadito3.style.display = "none";
            dadito4.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadito5.style.display = "none";
            dadito6.style.display = "none";
        break;
        case 5: // Para el caso de que salga un 5
            ...
            dadito3.style.display = "none";
            dadito4.style.display = "none";
            dadito5.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
            dadito6.style.display = "none";
        break;
        case 6: // Para el caso de que salga un 6
            dadito1.style.display = "none"; // Se deshabilitan el resto de imágenes
            ...
            dadito4.style.display = "none";
            dadito5.style.display = "none";
            dadito6.style.display = "block"; // Se pone para que se vea la imagen del dado correcto
        break;
    }
    return dadosTotal;
}
